...
@SourceType(value = "QuickBooksARP", label = "QuickBooks",uiConfig = "quickbooks-layout.json")
public class QuickBooksConf extends AbstractArpConf<QuickBooksConf> {
  private static final String ARP_FILENAME = "arp/implementation/quickbooks-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.quickbooks.QuickBooksDriver";
